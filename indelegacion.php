<html>
<head>
<title>INGRESAR DELEGACION </title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          </nav><CENTER><P><align="center"><FONT FACE="Arial" SIZE="6" COLOR="BLACK">INGRESAR DELEGACION</FONT></P>

  <form action="redelegacion.php" method="POST">
  <center>
<BR><BR>  
<label for="clave">Clave de la delegacion </label>
      <input type="text" name="clave" class="form-input">      
	 <BR><BR>
      <label for="nombre">Nombre de la delegacion </label>
