...
echo "<tr><td>". $row["id_m"]. "</td>";
echo "<td>". $row["nom_m"]. "</td>";

echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['id_m'].">Editar</a></td></tr>";
}
?>
	</table>
	</div>
...
//echo $id;
		$sql = "SELECT * FROM ".$tabla." WHERE id_m=".$id;
	...
	<p>
	<input type="hidden" align="LEFT" name="id_m" value="<?php echo $registro['id_m'];?>" /><p>
	<p>NOMBRE:
	<input type="text" align="LEFT" name="nom_m" value="<?php echo $registro['nom_m'];?>"/><p>

	<input type="submit" value="Actualizar" name="actualizar">
	</form></div>
	<div align="center"><p><a href="mfmarca.php">Regresar a Cambios</a></p></div>
...
$subs_clave = utf8_decode($_POST['id_m']);
$subs_nombre = utf8_decode($_POST['nom_m']);
