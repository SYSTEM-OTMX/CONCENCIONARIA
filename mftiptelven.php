...
<tr>
	<td>CLAVE TIPO DE TELEDONO</td>
    <td>CLAVE VENDEDOR </td>
	<td>NUMNERO TELFONO VENDEDOR</td>

</tr>

<?
while ($row=mysql_fetch_array($resultado)){
echo "<tr><td>". $row["id_tipo2"]. "</td>";
echo "<td>". $row["id_v1"]. "</td>";
echo "<td>". $row["num_telv"]. "</td>";

echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['id_tipo2'].">Editar</a></td></tr>";
}
?>
	</table>
	</div>
...
//echo $id;
		$sql = "SELECT * FROM ".$tabla." WHERE id_tipo2=".$id;
	...
	<html>
    	...
    	<body>
	<h1><div align="center">EDITANDO DATOS DE MARCA</div></h1>
	<BODY BACKGROUND="negro.jpg">

	<div align="center">
	<form action="<?php echo $_SERVER['PHP_self'];?>" method="post" name="mfcliente.php">
	<p>
	<input type="hidden" align="LEFT" name="id_tipo2" value="<?php echo $registro['id_tipo2'];?>" /><p>
	<p>NOMBRE:
	<input type="text" align="LEFT" name="num_telv" value="<?php echo $registro['num_telv'];?>"/><p>

	<input type="submit" value="Actualizar" name="actualizar">
	</form></div>
	<div align="center"><p><a href="mftiptelven.php">Regresar a Cambios</a></p></div>
...
$subs_clave = utf8_decode($_POST['id_tipo2']);
$subs_nombre = utf8_decode($_POST['num_telv']);

		$sql="UPDATE ".$tabla." SET
		num_telv=' $subs_nombre'
		WHERE id_tipo2=".$id;
