...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          </nav><CENTER><P><align="center"><FONT FACE="Arial" SIZE="6" COLOR="BLACK">INGRESAR COLONIA</FONT></P>

  <form action="recolonia.php" method="POST">
  <center>
<BR><BR>  
<label for="clave">Clave de la colonia </label>
