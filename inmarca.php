...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <CENTER><P><align="center"><FONT FACE="Arial" SIZE="6" COLOR="BLACK">INGRESAR MARCA</FONT></P>
	
  <form action="remarca.php" method="POST">
  <center>
<BR><BR>  
<label for="clave">Clave de la marca </label>
