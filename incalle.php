...
<body>
  ...
  <CENTER><P><align="center"><FONT FACE="Arial" SIZE="6" COLOR="BLACK">INGRESAR CALLE</FONT></P>
  
  <form action="recalle.php" method="POST">
  <center>
<BR><BR>  
<label for="clave">Clave de la calle </label>
