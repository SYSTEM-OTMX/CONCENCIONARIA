...
echo "<tr><td>". $row["id_del"]. "</td>";
echo "<td>". $row["nom_del"]. "</td>";

echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['id_del'].">Editar</a></td></tr>";
}
?>
	</table>
	</div>
...
//echo $id;
		$sql = "SELECT * FROM ".$tabla." WHERE id_del=".$id;
	...
	<html>
    	...
    	<body>
	<h1><div align="center">EDITANDO DATOS DE DELEGACION</div></h1>
	<BODY BACKGROUND="negro.jpg">
	...
	<div align="center"><p><a href="mfdelegacion.php">Regresar a Cambios</a></p></div>
...
$subs_clave = utf8_decode($_POST['id_del']);
$subs_nombre = utf8_decode($_POST['nom_del']);
