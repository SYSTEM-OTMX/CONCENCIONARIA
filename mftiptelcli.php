...
<CENTER>
	<P>
		<align="center">
			<FONT FACE="Arial" SIZE="6" COLOR="BLACK">Modificar</FONT>
	</P>
...
?>
			...
			<h1>
				<div align="center">Contenido de la base de datos
					<?php echo $db.", tabla ".$tabla;?>
				</div>
			</h1>
...
<body>
	<h1>
		<div align="center">EDITANDO DATOS DEL TIPO DE TELEFONO</div>
	</h1>
	...
	<BODY BACKGROUND="negro.jpg">
		...
		<div align="center">
			<form action="<?php echo $_SERVER['PHP_self'];?>" method="post" name="mfcliente.php">
				<p>
					<input type="hidden" align="LEFT" name="id_c1" value="<?php echo $registro['id_c1'];?>" />
				<p>
				<p>NOMBRE:
					<input type="text" align="LEFT" name="num_tel_c" value="<?php echo $registro['num_tel_c'];?>" />
				<p>
		...
		<div align="center">
			<p><a href="mftiptelcli.php">Regresar a Cambios</a></p>
		</div>
