<html>
<head>
<title>INGRESAR TIPO DE TELEFONO </title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          </nav><CENTER><P><align="center"><FONT FACE="Arial" SIZE="6" COLOR="BLACK">INGRESAR TIPO DE TELEFONO</FONT></P>
	
  <form action="retipotel.php" method="POST">
  <center>
<BR><BR>  
<label for="clave">Clave del tipo </label>
