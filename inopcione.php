...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          </nav>	<CENTER><P><align="center"><FONT FACE="Arial" SIZE="6" COLOR="BLACK">INGRESAR OPCIONE</FONT></P>

  <form action="reopcione.php" method="POST">
  <center>
<BR><BR>  
<label for="clave">Clave de la opcion</label>
      <input type="text" name="clave" class="form-input">      
	 <BR><BR>
      <label for="nombre">Nombre de la opcion</label>
      <input type="text" name="nombre" class="form-input" >   
     <BR> <BR>
	  <label for="nombre">Descuento de opcion </label>
      <input type="text" name="des" class="form-input" >   
     <BR> <BR>
