...
echo "<tr><td>". $row["id_OE"]. "</td>";
echo "<td>". $row["nom_OE"]. "</td>";
echo "<td>". $row["desc_OE"]. "</td>";

echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['id_OE'].">Editar</a></td></tr>";
}
?>
	</table>
	</div>
...
//echo $id;
		$sql = "SELECT * FROM ".$tabla." WHERE id_OE=".$id;
	...
	<html>
    	...
    	<body>
	<h1><div align="center">EDITANDO DATOS DE OPCION E</div></h1>
		<BODY BACKGROUND="negro.jpg">

	<div align="center">
	<form action="<?php echo $_SERVER['PHP_self'];?>" method="post" name="mfcliente.php">
	<p>
	<input type="hidden" align="LEFT" name="id_OE" value="<?php echo $registro['id_OE'];?>" /><p>
	<p>NOMBRE:
	<input type="text" align="LEFT" name="nom_OE" value="<?php echo $registro['nom_OE'];?>"/><p>
	<p>DESCUENTO:
	<input type="text" align="LEFT" name="desc_OE" value="<?php echo $registro['desc_OE'];?>"/><p>

	<input type="submit" value="Actualizar" name="actualizar">
	</form></div>
	<div align="center"><p><a href="mfopce.php">Regresar a Cambios</a></p></div>
...
$subs_clave = utf8_decode($_POST['id_OE']);
$subs_nombre = utf8_decode($_POST['nom_OE']);
$subs_desc = utf8_decode($_POST['desc_OE']);
