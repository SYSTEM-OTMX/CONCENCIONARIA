<html>
<head>
<title>INGRESAR COCHEUSADO </title>
...
<body>
  ...
  <CENTER><P><align="center"><FONT FACE="Arial" SIZE="6" COLOR="BLACK">INGRESAR COCHE</FONT></P>
  <form action="recoche.php" method="POST">
  <center>
<BR><BR>  
	<label for="clave">CLAVE DEL COCHE </label>
      <input type="text" name="clave" class="form-input">      
	 <BR><BR>
      <label for="nombre">MATRICULA </label>
      <input type="text" name="nombre" class="form-input" >   
     <BR> <BR>
	 <label for="clave">MODELO </label>
